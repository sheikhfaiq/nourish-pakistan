  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-hero-gradient px-4">
      <div className="max-w-md text-center">
        ...
        <a href="/" className="mt-6 inline-flex items-center justify-center rounded-full bg-leaf-gradient px-6 py-3 text-sm font-medium text-primary-foreground shadow-soft transition hover:opacity-95">
          Go home
        </a>
      </div>
    </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Personalised nutrition consultations across Pakistan. Weight loss, diabetes, PCOS, pregnancy and family nutrition — online with a certified nutritionist." },
      { name: "author", content: "Nourish with Ayesha" },
      { property: "og:title", content: "Nourish with Ayesha — Certified Nutritionist in Pakistan" },
      { property: "og:description", content: "Warm, evidence-based nutrition care for Pakistani lifestyles. Book an online consultation today." },
